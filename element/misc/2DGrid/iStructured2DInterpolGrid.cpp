...
tString iStructured2DInterpolGrid::getPropertyName(int index)
{
...
tString iStructured2DInterpolGrid::getPropertyType(int index)
{
	if (index == nInheritedProperties()){
		return "Int";
	} else if (index == nInheritedProperties()+1){
...
bool iStructured2DInterpolGrid::getPropertyValue(int index, tString propType, void* value)
{
...
bool iStructured2DInterpolGrid::setPropertyValue(int index, tString type, void* value)
{
...
bool iStructured2DInterpolGrid::isReadOnly(int index)
{
	if (index == nInheritedProperties()){
		return false;
	} else if (index == nInheritedProperties()+1){
