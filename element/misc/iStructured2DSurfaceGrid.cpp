...
tString iStructured2DSurfaceGrid::getPropertyName(unsigned int index)
{
...
tString iStructured2DSurfaceGrid::getPropertyType(unsigned int index)
{
	if (index == nInheritedProperties()){
		return "Int";
	} else if (index == nInheritedProperties()+1){
...
bool iStructured2DSurfaceGrid::getPropertyValue(unsigned int index, tString propType, void* value)
{
	if (index == 0 && propType == "String"){
		...
		*(int*)value = ((tStructured2DSurfaceGrid*)element)->nj();
		return true;
	} else if (index == nInheritedProperties()+2 && propType == "Surface"){
...
bool iStructured2DSurfaceGrid::setPropertyValue(unsigned int index, tString type, void* value)
{
	if (index == nInheritedProperties()+0 && type == "Int"){
		...
		return true;
	} else if(index == nInheritedProperties()+2 && type == "Surface"){
...
bool iStructured2DSurfaceGrid::isReadOnly(unsigned int index)
{
	if (index == nInheritedProperties()){
		return false;
	} else if (index == nInheritedProperties()+1){
